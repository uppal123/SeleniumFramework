...
1. Clone the repository:
   ```sh
   git clone https://github.com/uppal123/SeleniumFramework.git
   ```
...
- LinkedIn: [Your Profile](https://www.linkedin.com/in/pooja-uppal-09a51080/)
- GitHub: [Your GitHub](https://github.com/uppal123)
